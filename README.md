...
- **Colour is computed.** The palette was run through a contrast and colour-vision-deficiency
  validator instead of picked by eye. That caught a real defect in the palette this project used
  previously: the Bear amber sat at **1.92:1 contrast** against the chart surface, below the 3:1
  floor, and green/amber/red is the classic triad that collapses under red-green colour blindness
  (worst adjacent pair separated by ~3 units where 8 is the floor).
